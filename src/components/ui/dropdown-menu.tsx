...
const DropdownContext = createContext<DropdownContextType>({ onClick: () => { } });
...
function DropdownMenuItem({
  ...
  const { onClick } = useDropdownContext();
  return (
...
function DropdownMenuRadioItem({
  ...
  name,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.RadioItem> & { name: string }) {
  const { onClick } = useDropdownContext();
  return (
